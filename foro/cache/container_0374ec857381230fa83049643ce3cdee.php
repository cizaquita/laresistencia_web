...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'davidiq.mailinglist.listener' => 'getDavidiq_Mailinglist_ListenerService',
    ...
    /**
     * Gets the 'davidiq.mailinglist.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \davidiq\mailinglist\event\listener A davidiq\mailinglist\event\listener instance.
     */
    protected function getDavidiq_Mailinglist_ListenerService()
    {
        return $this->services['davidiq.mailinglist.listener'] = new \davidiq\mailinglist\event\listener($this->get('config'), './', 'php');
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'rescol', 'r3sc0l2016', 'resistencia_foro', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('davidiq.mailinglist.listener', 'davidiq\\mailinglist\\event\\listener');
        $instance->addSubscriberService('oneall.sociallogin.listener', 'oneall\\sociallogin\\event\\listener');
    ...
    /**
     * Gets the 'oneall.sociallogin.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \oneall\sociallogin\event\listener A oneall\sociallogin\event\listener instance.
     */
    protected function getOneall_Sociallogin_ListenerService()
    {
        return $this->services['oneall.sociallogin.listener'] = new \oneall\sociallogin\event\listener($this->get('config'), $this->get('config_text'), $this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('user'), './', 'php');
    }
    ...
    /**
     * Gets the 'vse.abbc3.acp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\event\acp_listener A vse\abbc3\event\acp_listener instance.
     */
    ...
    /**
     * Gets the 'vse.abbc3.acp_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\core\acp_manager A vse\abbc3\core\acp_manager instance.
     */
    ...
    /**
     * Gets the 'vse.abbc3.bbcodes_display' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\core\bbcodes_display A vse\abbc3\core\bbcodes_display instance.
     */
    ...
    /**
     * Gets the 'vse.abbc3.bbcodes_parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\core\bbcodes_parser A vse\abbc3\core\bbcodes_parser instance.
     */
    ...
    /**
     * Gets the 'vse.abbc3.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\event\listener A vse\abbc3\event\listener instance.
     */
    ...
    /**
     * Gets the 'vse.abbc3.wizard' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\abbc3\controller\wizard A vse\abbc3\controller\wizard instance.
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'rescol',
            'dbal.dbpasswd' => 'r3sc0l2016',
            'dbal.dbname' => 'resistencia_foro',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
